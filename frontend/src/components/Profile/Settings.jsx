...
const Settings = () => {
  ...
  useEffect(() => {
    const fetch = async()=>{
      const response = await axios.get(`http://localhost:3000/api/user/get-user`,{headers});
  ...
  const submitAddress = async() =>{
    const response = await axios.put(`http://localhost:3000/api/user/update-user`,Value, {headers});
